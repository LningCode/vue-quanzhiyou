  ...
  <div class="sign">
    ...
    <div class="cen-auto">
      ...
      <div class="login-main">
        <el-tabs class="login-group" stretch v-model="activeName" @tab-click="handleClick">
          ...
          <el-tab-pane label="注册" name="up">
            <div class="login-wrap">
              <div class="form-group text-left">
                <label for="nickname" class="control-label">名字</label>
                <el-input
                  name="nickname"
                  maxlength="11"
                  minlength="11"
              ...
              <div v-if="false" class="form-group text-left">
                <el-input
                  class="w-60"
                  name="phonecode"
                  maxlength="11"
        ...
        <p class="text-muted text-center">
          继续即表示你同意
          <router-link to="/tos">《服务条款》</router-link>和
...
export default {
  ...
  created() {
    ...
    this.activeName = param == "in" ? param : "in";
  },
  mounted() {}
};
</script>
